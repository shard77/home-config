{
  ...
  xdg.desktopEntries."org.gnome.Settings" = {
    ...
    icon = "org.gnomeSettings";
    exec = "env XFG_CURRENT_DESKTOP=gnome ${pkgs.gnome.gnome-control-center}/bin/gnome-control-center";
  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      in [
        ...
        ",XF86MonBrightnessDown, ${e} 'brightness.screen -= 0.06; indicator.display()'"
      ...
      in [
        ...
        ",XF86AudioMicMute, ${e} 'audio.microhone.isMuted = !audio.microphone.isMuted'"
      ];
